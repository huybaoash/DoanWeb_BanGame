...
namespace DoanWeb_BanGame.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,Country")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,Country")] Publisher publisher)
        {
            if (ModelState.IsValid)
            {
