...
namespace DoanWeb_BanGame.Controllers
{
    public class SalesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Code,Rate,StartDay,EndDay")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Code,Rate,StartDay,EndDay")] Sale sale)
        {
            if (ModelState.IsValid)
            {
